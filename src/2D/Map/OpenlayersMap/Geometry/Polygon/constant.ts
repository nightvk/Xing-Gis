...
/** 散多边形的图层名 */
export const SPLASHES_POLYGON_DEFAULT_LAYERNAME = 'SPLASHES_POLYGON_DEFAULT_LAYERNAME'
...
/** 多边形的样式类型 */
export interface PolygonStyleType extends BaseStyleType {
    activeStyle?: BaseStyleType
}

export interface PolygonOptionsType extends PolygonStyleType {
    /** 图层 */
...
export interface DrawPolygonOptionsType {
    layer?: string
    /** 基于初始位置绘制 */
