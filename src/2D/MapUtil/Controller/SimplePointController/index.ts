...
import SimplePoint from '../../Entities/SimplePoint'
import Layers from '../../Layers'
import Utils from '../../../../Utils'

import type { SimplePointType } from '../../Entities/SimplePoint'
...
export default class SimplePointController {
    ...
    private store: Map<string | number, SimplePoint>
     ...
     * @desc 绘制(新增+修改)
     */
    public draw = (param: SimplePointType) => {
        ...
        if (this.store.has(id)) {
            ...
            const newPoint = new SimplePoint(param)
            this.store.set(id, newPoint!)
